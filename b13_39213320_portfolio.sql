...
CREATE DATABASE IF NOT EXISTS `b13_39213320_portfolio` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `b13_39213320_portfolio`;
...
(4, '185.233.130.41', '2026-03-11', 1, '<u>Test de sécurité</u>', '<u>Test de sécurité<', 'test@gmail.com', '<u>Test de sécurité</u>'),
(5, '185.233.130.41', '2026-03-11', 1, 'echo \"Bonjour Mr \" . $nom;', 'echo \"Bonjour Mr \" .', 'test@gmail.com', 'echo \"Bonjour Mr \" . $nom;'),
(6, '185.233.130.41', '2026-03-11', 1, 'echo \"Bonjour Mr \" . htmlspecialchars($nom, ENT_QU', 'echo \"Bonjour Mr \" .', 'test@gmail.com', 'echo \"Bonjour Mr \" . htmlspecialchars($nom, ENT_QUOTES, \'UTF-8\');');
...
CREATE TABLE IF NOT EXISTS `projets` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `libelleProjet` varchar(100) NOT NULL,
